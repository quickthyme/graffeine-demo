...
class PieSlicesConfig: GraffeineViewConfig {
    ...
    let colors: [UIColor] = [
        UIColor.red.modifiedByAdding(alpha: -0.4),
        UIColor.purple.modifiedByAdding(alpha: -0.4),
        UIColor.blue.modifiedByAdding(alpha: -0.4),
        UIColor.orange.modifiedByAdding(alpha: -0.4),
        UIColor.systemPink.modifiedByAdding(alpha: -0.4),
        UIColor.systemIndigo.modifiedByAdding(alpha: -0.4),
    ]
